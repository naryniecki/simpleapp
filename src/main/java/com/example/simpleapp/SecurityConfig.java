...
//        web.ignoring().antMatchers(ELOQUA_CONFIGURE_ENDPOINT, ELOQUA_INSTALL_ENDPOINT, ELOQUA_UNINSTALL_ENDPOINT, ELOQUA_STATUS_ENDPOINT, ELOQUA_AUTHORIZATION_CODE_ENDPOINT, "/all", "/code");
//    }
//}
